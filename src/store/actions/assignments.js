...
export const getASNTS = token => {
  return dispatch => {
    ...
    axios
      .get("https://class-ro-om.herokuapp.com/application/assignment")
      .then(res => {
...
export const getASNTSDetail = (token, id) => {
  return dispatch => {
    ...
    axios
      .get(`https://class-ro-om.herokuapp.com/application/assignment/${id}`)
      .then(res => {
...
export const createASNT = (token, asnt) => {
  return dispatch => {
    ...
    console.log(asnt)
    axios
      .post(`https://class-ro-om.herokuapp.com/application/assignment/`, asnt)
      .then(res => {
