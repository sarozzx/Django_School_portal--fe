...
export const GET_G_ASSIGNMENT_LIST_START = "GET_G_ASSIGNMENT_LIST_START";
export const GET_G_ASSIGNMENTS_LIST_FAIL = "GET_G_ASSIGNMENTS_LIST_FAIL";
export const GET_G_ASSIGNMENTS_LIST_SUCCESS = "GET_G_ASSIGNMENTS_LIST_SUCCESS";
